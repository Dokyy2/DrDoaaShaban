-- Run this ONCE in Supabase SQL Editor for the project that already has schema.sql.
-- It preserves current doctor/secretary accounts and makes all future accounts pending.
